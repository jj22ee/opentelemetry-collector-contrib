module github.com/jj22ee/opentelemetry-collector-contrib/internal/metadataproviders
...
replace github.com/jj22ee/opentelemetry-collector-contrib/internal/k8sconfig => ../k8sconfig
