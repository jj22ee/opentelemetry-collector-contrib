...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/awsutil v0.121.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/cwlogs v0.121.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/metrics v0.121.0
